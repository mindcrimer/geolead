...
from reports.utils import get_period, get_wialon_geozones_report_template_id, \
    ...
    parse_timedelta, format_timedelta, utc_to_local_time
    ...
    def post(self, request, *args, **kwargs):
        ...
        for unit_el in units_els:
            ...
            for row in report_data['unit_rides']:
                ...
                point_info = {
                    # TODO: SPACE
                    'name': row_data[RIDES_GEOZONE_FROM_COL],
                    'time_in': time_in,
                    'time_out': time_out,
                    'params': OrderedDict((
                        ...
                        ('fuelRefill', ''),
                        ('fuelDrain', ''),
                        ('stopMinutes', row_data[RIDES_TIME_PARKING_COL]),
                        ('moveMinutes', format_timedelta(max(0, move_time))),
                        ('motoHours', ''),
                        (
                            'odometer',
